...
void UBlasterAnimInstance::NativeInitializeAnimation()
{
	...
	BlasterCharacter = Cast<ABlasterCharacterBase>(TryGetPawnOwner());
}
...
void UBlasterAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
	...
	bJumped = BlasterCharacter->IsJumped();
	...
	TurnPlayRateBP = BlasterCharacter->GetTurnPlayRate();
	HeadLookPitchBP = BlasterCharacter->GetHeadLookPitch();
	...
	const float Interp = FMath::FInterpTo(Lean, Target, DeltaSeconds, 1.5f);
